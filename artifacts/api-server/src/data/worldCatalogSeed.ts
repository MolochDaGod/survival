...
export const SEED_SECTORS: SeedSector[] = [
  {
    ...
    campBodies: ['toon-nim', 'toon-suture', 'toon-permafrost'], fauna: ['mountain_goat', 'cave_bat', 'black_bear'],
  ...
  },
  {
    ...
    campBodies: ['toon-nim', 'toon-suture', 'toon-bastion'], fauna: ['mountain_goat', 'hawk', 'cave_bat', 'black_bear'],
  ...
  },
  {
    ...
    campBodies: ['toon-vex', 'toon-rivet', 'toon-ashcoil'], fauna: ['rat_swarm', 'crow_flock', 'junkyard_dog'],
  ...
  },
  {
    ...
    campBodies: ['toon-ledger', 'toon-scope', 'toon-ashcoil'], fauna: ['deer', 'rabbit', 'pheasant', 'wild_horse'],
  ...
  },
  {
    ...
    lore: 'Safe zone at the world origin. Stake Claim Flag on middle pad.',
    flow: { title: 'Convergence Nexus', subtitle: 'Safe encampment', objective: 'Stake your Claim Flag on the middle pad, then pick a faction road' },
    ...
    campBodies: ['toon-ledger', 'toon-brick', 'toon-rivet'], fauna: ['rabbit', 'deer', 'pheasant'],
  ...
  },
  {
    ...
    campBodies: ['toon-vex', 'toon-rivet', 'toon-bastion'], fauna: ['rat_swarm', 'crow_flock', 'junkyard_dog'],
  ...
  },
  {
    ...
    campBodies: ['toon-cinder', 'toon-greyvial', 'toon-permafrost'], fauna: ['crab', 'eel', 'saltwater_croc'],
  ...
  },
  {
    ...
    campBodies: ['toon-brick', 'toon-bastion', 'toon-cinder'], fauna: ['cave_spider', 'blind_newt', 'magma_crab', 'black_bear'],
  ...
  },
  {
    ...
    campBodies: ['toon-greyvial', 'toon-permafrost', 'toon-cinder'], fauna: ['crab', 'eel', 'pelican', 'saltwater_croc'],
