...
export const ITEM_DATABASE: Record<string, ItemDef> = {
  ...
  leather_cap: {
    ...
    icon: '/icons/cyberpunk-weapons/Icon1_09.png', description: 'Basic head protection.',
    stats: { armor: 4, health: 8 },
  },
  iron_helm: {
    id: 'iron_helm', name: 'Iron Helm', slot: 'helm', rarity: 'uncommon',
    icon: '/icons/cyberpunk-weapons/Icon1_15.png', description: 'Sturdy iron helmet.',
    stats: { armor: 10, health: 15, endurance: 1 },
  },
  shadow_hood: {
    id: 'shadow_hood', name: 'Shadow Hood', slot: 'helm', rarity: 'rare',
    icon: '/icons/cyberpunk-artifacts/Icon22_05.png', description: 'Hood of the dusk-walker.',
    stats: { armor: 8, agility: 3, critChance: 5 },
  },
  dragon_crown: {
    id: 'dragon_crown', name: 'Dragon Crown', slot: 'helm', rarity: 'legendary',
    icon: '/icons/cyberpunk-artifacts/Icon22_01.png', description: 'Forged from a dragon\'s skull.',
  ...
  cloth_tunic: {
    ...
    icon: '/icons/cyberpunk-weapons/Icon1_14.png', description: 'Simple cloth shirt.',
    stats: { armor: 6, mana: 10 },
  },
  iron_breastplate: {
    id: 'iron_breastplate', name: 'Iron Breastplate', slot: 'chest', rarity: 'uncommon',
    icon: '/icons/cyberpunk-weapons/Icon1_11.png', description: 'Heavy iron chest armor.',
    stats: { armor: 22, health: 30, endurance: 2 },
  },
  mage_robe: {
    id: 'mage_robe', name: 'Mage Robe', slot: 'chest', rarity: 'rare',
    icon: '/icons/cyberpunk-artifacts/Icon22_10.png', description: 'Robes woven with arcane thread.',
    stats: { armor: 12, mana: 40, intelligence: 5 },
  },
  void_plate: {
    id: 'void_plate', name: 'Voidplate', slot: 'chest', rarity: 'epic',
    icon: '/icons/cyberpunk-artifacts/Icon22_20.png', description: 'Plate forged in the void.',
  ...
  leather_pants: {
    ...
    icon: '/icons/cyberpunk-weapons/Icon1_12.png', description: 'Worn leather leggings.',
    stats: { armor: 5, moveSpeed: 2 },
  },
  iron_greaves: {
    id: 'iron_greaves', name: 'Iron Greaves', slot: 'legs', rarity: 'uncommon',
    icon: '/icons/cyberpunk-weapons/Icon1_13.png', description: 'Heavy leg plates.',
    stats: { armor: 14, health: 20 },
  },
  shadowsilk_pants: {
    id: 'shadowsilk_pants', name: 'Shadowsilk Pants', slot: 'legs', rarity: 'rare',
    icon: '/icons/cyberpunk-artifacts/Icon22_08.png', description: 'Silken pants of the night.',
  ...
  leather_boots: {
    ...
    icon: '/icons/cyberpunk-weapons/Icon1_17.png', description: 'Soft walking boots.',
    stats: { armor: 3, moveSpeed: 3 },
  },
  swift_treads: {
    id: 'swift_treads', name: 'Swift Treads', slot: 'boots', rarity: 'uncommon',
    icon: '/icons/cyberpunk-weapons/Icon1_25.png', description: 'Lighter than air.',
    stats: { armor: 5, moveSpeed: 10, agility: 3 },
  },
  warlords_sabatons: {
    id: 'warlords_sabatons', name: "Warlord's Sabatons", slot: 'boots', rarity: 'epic',
    icon: '/icons/cyberpunk-artifacts/Icon22_15.png', description: 'Boots of an ancient warlord.',
  ...
  wooden_shield: {
    ...
    icon: '/icons/cyberpunk-weapons/Icon1_19.png', description: 'Simple roundshield.',
    stats: { armor: 8, health: 10 },
  },
  iron_shield: {
    id: 'iron_shield', name: 'Iron Shield', slot: 'offhand', rarity: 'uncommon',
    icon: '/icons/cyberpunk-weapons/Icon1_20.png', description: 'Bound in iron.',
    stats: { armor: 18, endurance: 3 },
  },
  arcane_focus: {
    id: 'arcane_focus', name: 'Arcane Focus', slot: 'offhand', rarity: 'rare',
    icon: '/icons/cyberpunk-artifacts/Icon22_03.png', description: 'A floating crystal of power.',
  ...
  copper_ring: {
    ...
    icon: '/icons/genetics/Icon11_22.png', description: 'Simple copper band.',
    stats: { health: 10 },
  },
  ring_of_might: {
    id: 'ring_of_might', name: 'Ring of Might', slot: 'ring', rarity: 'rare',
    icon: '/icons/cyberpunk-artifacts/Icon22_06.png', description: 'A warrior\'s ring.',
    stats: { strength: 4, damage: 5 },
  },
  ring_of_swiftness: {
    id: 'ring_of_swiftness', name: 'Ring of Swiftness', slot: 'ring', rarity: 'rare',
    icon: '/icons/genetics/Icon11_20.png', description: 'Lightens your step.',
    stats: { agility: 4, moveSpeed: 6, attackSpeed: 5 },
  },
  band_of_kings: {
    id: 'band_of_kings', name: 'Band of Kings', slot: 'ring', rarity: 'legendary',
    icon: '/icons/cyberpunk-artifacts/Icon22_04.png', description: 'Worn by ancient sovereigns.',
  ...
  bone_charm: {
    ...
    icon: '/icons/genetics/Icon11_01.png', description: 'A small bone trinket.',
    stats: { health: 12 },
  },
  amulet_of_focus: {
    id: 'amulet_of_focus', name: 'Amulet of Focus', slot: 'amulet', rarity: 'uncommon',
    icon: '/icons/genetics/Icon11_15.png', description: 'Sharpens the mind.',
    stats: { mana: 25, intelligence: 3 },
  },
  heartstone_pendant: {
    id: 'heartstone_pendant', name: 'Heartstone Pendant', slot: 'amulet', rarity: 'epic',
    icon: '/icons/cyberpunk-artifacts/Icon22_02.png', description: 'Pulses with vital energy.',
