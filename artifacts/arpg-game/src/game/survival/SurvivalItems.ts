 ...
 */
import { GENERATED_SURVIVAL_ITEMS } from './SurvivalItems.generated';
...
export const SURVIVAL_ITEMS: Record<string, SurvivalItemDef> = {
  ...
  orc_flag:       { id: 'orc_flag',       name: 'Faction Banner',  category: 'structure', icon: '🚩', weight: 2.0,  stack: 2, modelPath: '/models/props/orc-props/_flag.fbx',        description: 'Plant your faction colors (Keepers / Scavengers / Hollow / Network / Forgotten banners). Marks camp and city ownership on the map and at the pole.', placeable: true },
