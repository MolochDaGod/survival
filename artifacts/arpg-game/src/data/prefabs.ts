...
export const PREFABS: PrefabDef[] = [
  ...
  // ── Vehicles / boats ──────────────────────────────────────────────────────
  { id: 'viking_shipyard', file: 'viking_shipyard.glb',                                   kind: 'building',     label: 'Viking Shipyard', scale: 6.0, footprint: 55, interaction: 'gate:deploy',     tags: ['boat', 'shipyard', 'deploy', 'dock', 'gate', 'viking', 'island_dock', 'home_island', 'town_island'] },
  ...
  // assetPath points at CDN-synced maps under models/prefabs/ (same as PrefabSystem).
  // SectorWorldBootstrap maps sector.glbMap → these ids (must stay in sync).
  { id: 'terrain_quick',     file: 'free_quick_terrain_test.glb',                         kind: 'terrain_patch', label: 'Quick Terrain Test',  scale: 1.0, patchRadius: 80,  blendRing: 40, footprint: 120, tags: ['terrain', 'test'], assetPath: '/models/prefabs/free_quick_terrain_test.glb' },
  { id: 'terrain_snow_mtn',  file: 'snowy_mountain_-_terrain.glb',                        kind: 'terrain_patch', label: 'Snowy Mountain',      scale: 1.0, patchRadius: 200, blendRing: 80, footprint: 280, tags: ['terrain', 'snow', 'mountain', 'cold'], assetPath: '/models/prefabs/snowy_mountain_-_terrain.glb' },
  { id: 'terrain_cg_misty',  file: 'chicken_gun_mistytown.glb',                           kind: 'terrain_patch', label: 'Misty Town Map',      scale: 1.0, patchRadius: 110, blendRing: 50, footprint: 160, tags: ['terrain', 'town', 'misty', 'cg', 'sector_map'], assetPath: '/models/prefabs/chicken_gun_mistytown.glb' },
  { id: 'terrain_cg_western',file: 'chicken_gun_western_reupload.glb',                    kind: 'terrain_patch', label: 'Western Town Map',    scale: 1.0, patchRadius: 130, blendRing: 60, footprint: 190, tags: ['terrain', 'town', 'western', 'cg', 'desert', 'sector_map'], assetPath: '/models/prefabs/chicken_gun_western_reupload.glb' },
  { id: 'terrain_cg_encamp', file: 'chicken_gun_fruzer_-_encampment.glb',                 kind: 'terrain_patch', label: 'Fruzer Encampment',   scale: 1.0, patchRadius: 110, blendRing: 50, footprint: 160, tags: ['terrain', 'camp', 'cg', 'sector_map'], assetPath: '/models/prefabs/chicken_gun_fruzer_-_encampment.glb' },
  { id: 'terrain_cg_bigfarm',file: 'chicken_gun_bigfarm_full_map.glb',                    kind: 'terrain_patch', label: 'Big Farm Map',        scale: 1.0, patchRadius: 160, blendRing: 70, footprint: 230, tags: ['terrain', 'farm', 'rural', 'cg', 'sector_map'], assetPath: '/models/prefabs/chicken_gun_bigfarm_full_map.glb' },
  { id: 'terrain_cg_town2f', file: 'chicken_gun_town2f_reupload.glb',                     kind: 'terrain_patch', label: 'Town 2F Map',         scale: 1.0, patchRadius: 140, blendRing: 60, footprint: 200, tags: ['terrain', 'town', 'cg', 'sector_map'], assetPath: '/models/prefabs/chicken_gun_town2f_reupload.glb' },
  { id: 'terrain_cg_town3f', file: 'town3f2_chicken_gun_map_reupload.glb',                kind: 'terrain_patch', label: 'Town 3F Map',         scale: 1.0, patchRadius: 160, blendRing: 70, footprint: 230, tags: ['terrain', 'town', 'cg', 'sector_map'], assetPath: '/models/prefabs/town3f2_chicken_gun_map_reupload.glb' },
