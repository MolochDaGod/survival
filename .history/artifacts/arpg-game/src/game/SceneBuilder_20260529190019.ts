...
export class SceneBuilder {
  ...
  /** Rapier world. Optional — when null the terrain + chunks skip collider
   *  baking (legacy BVH-only path). Threaded through to TerrainBuilder and
   *  WorldChunkManager so streamed heightfields and the arena disk get
   *  Rapier representations matching the visual geometry. */
