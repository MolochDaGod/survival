...
export const DEPLOYABLES: DeployableDef[] = [
  ...
  // ── Quaternius mech pack (animated GLTF) ─────────────────────────────────
  // Dual-role: player-deployable allies at SYN-5, and the same rigs appear
  // as hostile-mech enemies in creatures.ts. Driven by the animated_pack
  // GLTFs (clips: Idle, Walk, Run, Attack, Death) — not the static FBX
  // variant under /models/enemies/mechs/Textured/FBX/.
  {
    id: 'mech_stan_deploy',
    kind: 'mech',
    name: 'STAN Frame',
    description: 'Heavy bipedal escort mech. Slow but resilient — soaks fire on the front line. Mirrors the STAN hostile spawn.',
    prefabId: 'mech_stan_ally',
    modelPath: '/models/mechs/animated_pack/glTF/Stan.gltf',
    scale: 0.018,
    defaultRole: 'ally',
    allowedRoles: ['ally', 'enemy', 'patrol'],
    tier: 5,
    stats: { maxHealth: 450, damage: 60, range: 4, attackSpeed: 0.9, moveSpeed: 4, armor: 75, duration: 90, cooldown: 240 },
    anims: { idle: 'Idle', deploy: 'Idle', active: 'Walk', attack: 'Attack', move: 'Run', death: 'Death' },
    unlock: { stat: 'syn', milestone: 5 },
    tags: ['synthetic', 'mech', 'quaternius', 'heavy', 'frontline'],
  },
  {
    id: 'mech_mike_deploy',
    kind: 'mech',
    name: 'MIKE Frame',
    description: 'Mid-weight assault mech. Balanced damage and armor — workhorse of the SYN mech roster.',
    prefabId: 'mech_mike_ally',
    modelPath: '/models/mechs/animated_pack/glTF/Mike.gltf',
    scale: 0.018,
    defaultRole: 'ally',
    allowedRoles: ['ally', 'enemy', 'patrol'],
    tier: 5,
    stats: { maxHealth: 380, damage: 70, range: 4, attackSpeed: 1.0, moveSpeed: 5, armor: 60, duration: 90, cooldown: 240 },
    anims: { idle: 'Idle', deploy: 'Idle', active: 'Walk', attack: 'Attack', move: 'Run', death: 'Death' },
    unlock: { stat: 'syn', milestone: 5 },
    tags: ['synthetic', 'mech', 'quaternius', 'assault'],
  },
  {
    id: 'mech_leela_deploy',
    kind: 'mech',
    name: 'LEELA Frame',
    description: 'Ranged-support mech. Lower HP but extended kinetic-rifle range. Holds the rear of a mech line.',
    prefabId: 'mech_leela_ally',
    modelPath: '/models/mechs/animated_pack/glTF/Leela.gltf',
    scale: 0.018,
    defaultRole: 'ally',
    allowedRoles: ['ally', 'enemy', 'station'],
    tier: 5,
    stats: { maxHealth: 280, damage: 55, range: 22, attackSpeed: 1.4, moveSpeed: 5, armor: 35, duration: 90, cooldown: 240 },
    anims: { idle: 'Idle', deploy: 'Idle', active: 'Walk', attack: 'Attack', move: 'Run', death: 'Death' },
    unlock: { stat: 'syn', milestone: 5 },
    tags: ['synthetic', 'mech', 'quaternius', 'ranged', 'support'],
  },
  {
    id: 'mech_george_deploy',
    kind: 'mech',
    name: 'GEORGE Frame',
    description: 'Skirmisher mech. Highest mobility in the pack; flanks targets and re-engages from new angles.',
    prefabId: 'mech_george_ally',
    modelPath: '/models/mechs/animated_pack/glTF/George.gltf',
    scale: 0.018,
    defaultRole: 'ally',
    allowedRoles: ['ally', 'enemy', 'patrol'],
    tier: 5,
    stats: { maxHealth: 320, damage: 50, range: 4, attackSpeed: 1.3, moveSpeed: 7, armor: 40, duration: 90, cooldown: 240 },
    anims: { idle: 'Idle', deploy: 'Idle', active: 'Walk', attack: 'Attack', move: 'Run', death: 'Death' },
    unlock: { stat: 'syn', milestone: 5 },
    tags: ['synthetic', 'mech', 'quaternius', 'skirmisher', 'fast'],
  },

  // Robot T-1 — capstone SYN-6 pilotable. Mirrors the hostile-mech spawn
  // in creatures.ts; same 55 MB GLB asset, dual-role via allowedRoles.
  {
    id: 'robot_t1_deploy',
    kind: 'mech',
    name: 'Robot T-1',
    description: 'Pilotable heavy frame. Player enters and gains +300 HP shield, plasma cannon, and ground-shock slam. 75s duration.',
    prefabId: 'mech_robot_t1',
    modelPath: '/models/mechs/robot_t1/robot_t1.glb',
    scale: 0.022,
    defaultRole: 'ally',
    allowedRoles: ['ally', 'enemy'],
    tier: 6,
    stats: { maxHealth: 600, damage: 110, range: 6, attackSpeed: 0.8, moveSpeed: 5, armor: 100, duration: 75, cooldown: 360 },
    anims: { idle: 'Idle', deploy: 'Idle', active: 'Walk', attack: 'Attack', move: 'Run', death: 'Death' },
    unlock: { stat: 'syn', milestone: 6 },
    tags: ['synthetic', 'mech', 'pilotable', 'capstone', 'heavy', 'combat'],
  },
];
