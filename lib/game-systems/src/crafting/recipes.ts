...
export type CraftingStation =
  ...
  | 'workbench'
  | 'drying_rack'
  /** Survival camp professional benches (same recipes as workbench+, require camp claim). */
  | 'profession_bench';
...
export const RECIPES: Recipe[] = [
  ...
  // ===== LOW-POLY FARM WOOD PROPS =====
  {
    ...
    station: 'none',
    craftTime: 6,
    inputs: [{ itemId: 'wood_chopped', qty: 3 }],
    outputs: [{ itemId: 'wt_fence', qty: 2 }],
    description: 'Low-poly fence segment from the village wood pack.',
  },
  {
    id: 'build_wt_bucket',
    name: 'LP Wood Bucket',
    iconItemId: 'wt_bucket',
    station: 'none',
    craftTime: 5,
    inputs: [{ itemId: 'wood_chopped', qty: 2 }, { itemId: 'branch_a', qty: 1 }],
    outputs: [{ itemId: 'wt_bucket', qty: 1 }],
    description: 'Wooden bucket for camp water collection.',
  },
  {
    id: 'build_wt_ladder',
    name: 'LP Wood Ladder',
    iconItemId: 'wt_ladder',
    station: 'workbench',
    craftTime: 10,
    inputs: [{ itemId: 'wood_chopped', qty: 4 }, { itemId: 'branch_b', qty: 2 }],
    outputs: [{ itemId: 'wt_ladder', qty: 1 }],
    description: 'Climbable ladder segment.',
  },
  {
    id: 'build_wt_box',
    name: 'LP Wood Crate',
    ...
    craftTime: 8,
    inputs: [{ itemId: 'wood_chopped', qty: 4 }],
    outputs: [{ itemId: 'wt_box', qty: 1 }],
    description: 'Supply crate for camp storage.',
  },
  {
    id: 'build_wt_barrel',
    name: 'LP Wood Barrel',
    iconItemId: 'wt_barrel',
    station: 'workbench',
    craftTime: 10,
    inputs: [{ itemId: 'wood_chopped', qty: 5 }],
    outputs: [{ itemId: 'wt_barrel', qty: 1 }],
    description: 'Wooden storage barrel.',
  },
  {
    id: 'build_wt_sign',
    name: 'LP Wood Signpost',
    iconItemId: 'wt_sign',
    station: 'none',
    craftTime: 6,
    inputs: [{ itemId: 'wood_chopped', qty: 2 }, { itemId: 'branch_a', qty: 2 }],
    outputs: [{ itemId: 'wt_sign', qty: 1 }],
    description: 'Mark roads and camp entrances.',
  },
  ...
  /**
   * craft_claim_flag — Survival camp authority (docs/inventory).
   * Placing the flag claims an 80m camp, spawns an unarmed variant of the
   * player race/body, and enables bench + building camp buffs.
   * Alias of faction banner for design-doc parity (not Warlords).
   */
  {
    id: 'craft_claim_flag',
    name: 'Claim Flag',
    iconItemId: 'claim_flag',
    station: 'none',
    craftTime: 12,
    inputs: [
      { itemId: 'branch_b', qty: 4 },
      { itemId: 'duct_tape', qty: 2 },
      { itemId: 'wood_chopped', qty: 2 },
    ],
    outputs: [{ itemId: 'claim_flag', qty: 1 }],
    description:
      'Plant to claim camp (80m). Spawns an unarmed guardian of your race. Required for hires & raids.',
  },
  {
    id: 'build_workbench',
    name: 'Profession Workbench',
    iconItemId: 'workbench',
    station: 'none',
    craftTime: 18,
    inputs: [
      { itemId: 'wood_chopped', qty: 10 },
      { itemId: 'rock_7', qty: 2 },
    ],
    outputs: [{ itemId: 'workbench', qty: 1 }],
    description:
      'Camp crafting bench — unlocks professional Crafting tiers and bonus profession XP inside the claim.',
  },
  {
    ...
    station: 'workbench',
    craftTime: 14,
    inputs: [{ itemId: 'wood_chopped', qty: 8 }],
    outputs: [{ itemId: 'orc_barrel_1', qty: 1 }],
    description: 'Camp storage building — modest harvest capacity buff for camp NPCs.',
  },
  {
    id: 'build_campfire',
    name: 'Campfire',
    ...
    station: 'none',
    craftTime: 8,
    inputs: [{ itemId: 'branch_a', qty: 4 }, { itemId: 'branch_b', qty: 2 }],
    outputs: [{ itemId: 'campfire', qty: 1 }],
    description: 'Baseline camp hearth — chemistry / cooking station.',
  },
  {
    id: 'build_tent_personal',
    name: 'Personal Tent',
    iconItemId: 'build_tent_personal',
    station: 'none',
    craftTime: 16,
    inputs: [{ itemId: 'wood_chopped', qty: 6 }, { itemId: 'duct_tape', qty: 4 }],
    outputs: [{ itemId: 'build_tent_personal', qty: 1 }],
    description: 'One tent per recruited NPC hire (Survival camp requirement).',
  },
  {
    id: 'build_signpost',
    name: 'Signpost',
