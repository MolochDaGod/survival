...
export const SURVIVAL_ITEMS: Record<string, SurvivalItemDef> = {
  ...
  campfire:    { id: 'campfire',    name: 'Campfire',    category: 'structure', icon: '🔥', weight: 5.0, stack: 4, modelPath: `${M_ITEM}/Campfire.fbx`,    description: 'Warmth, light, cooking. Camp chemistry bench inside claim radius.', placeable: true },
  ...
  /** Survival claim flag — planting claims camp + unarmed race guardian (CampClaimSystem). */
  claim_flag:     { id: 'claim_flag',     name: 'Claim Flag',      category: 'structure', icon: '🚩', weight: 2.5,  stack: 1, modelPath: '/models/props/orc-props/_flag.fbx',        description: 'Claim an 80m camp. Spawns unarmed guardian of your race. Enables hires, benches, and raid radius.', placeable: true },
  workbench:      { id: 'workbench',      name: 'Profession Workbench', category: 'structure', icon: '🪚', weight: 8.0, stack: 2, modelPath: '/models/props/orc-props/_crate.fbx', description: 'Camp crafting bench — professional Crafting XP and recipe tiers inside claim.', placeable: true },
  build_tent_personal: { id: 'build_tent_personal', name: 'Personal Tent', category: 'structure', icon: '⛺', weight: 6.0, stack: 8, modelPath: '/models/props/orc-props/_crate.fbx', description: 'Housing for one recruited camp NPC.', placeable: true },
