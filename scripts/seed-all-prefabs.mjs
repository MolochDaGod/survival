...
const PREFABS = [
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    ...
    description:
      "Massive winged dragon. Multiple attack types including flame breath and wing claw.",
        ...
        phases: [
          {
            ...
            attacks: ["Basic Attack", "AttackWingClaw"],
          },
          {
            hpThreshold: 0.5,
            behavior: "ranged_strafe",
            attacks: ["Flame Attack", "AttackWingClaw"],
          },
          {
            hpThreshold: 0.2,
            behavior: "enraged",
  ...
  },
  {
    ...
    name: "Dragon Usurper",
    description:
      "Ancient dragon with flame, hand, and mouth attacks. Final boss tier.",
    ...
    data: {
      ...
      ai: {
        phases: [
          ...
          {
            hpThreshold: 0.7,
            attacks: ["attackFlame", "attackHand"],
            behavior: "alternate",
          },
          {
            hpThreshold: 0.3,
            attacks: ["attackMouth", "attackFlame"],
            behavior: "enraged",
            speedMult: 2.0,
          },
        ],
    ...
    data: {
      ...
      ai: {
        ...
        phases: [
          ...
          {
            hpThreshold: 0.5,
            attacks: ["Fly Fireball Shoot", "Fireball Shoot"],
            behavior: "fly_strafe",
          },
          {
            hpThreshold: 0.2,
            attacks: ["Basic Attack"],
            behavior: "desperate_melee",
          },
        ],
      },
      lootTable: "boss",
  ...
  },
  {
    ...
    description:
      "Fast aggressive dragon with claw attacks and terrifying scream.",
    ...
    data: {
      ...
      ai: {
        screamCooldown: 15,
        screamRadius: 12,
        screamFearDuration: 3,
        phases: [
          { hpThreshold: 1.0, attacks: ["Basic Attack"], behavior: "chase" },
          {
            hpThreshold: 0.6,
            attacks: ["Claw Attack", "Basic Attack"],
            behavior: "aggressive",
          },
          {
            hpThreshold: 0.3,
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "Titan",
    description:
      "Colossal humanoid. Slow but devastating ground-pound attacks.",
  ...
  },
  {
    ...
    name: "Arachnid",
    description:
      "Giant spider with dual attack types and a fear-inducing shout.",
  ...
  },
  {
    ...
    name: "Juggernaut",
    description:
      "Armored bruiser with 3 attack combos. High HP, moderate speed.",
    ...
    data: {
      ...
      animations: {
        ...
        run: "run",
        death: "Dead",
        attacks: ["Attack(1)", "Attack(2)", "Attack(6)"],
      },
  ...
  },
  {
    ...
    data: {
      ...
      animations: {
        ...
        run: "run01",
        death: "die01",
        attacks: ["attack01", "attack02", "attack03"],
      },
      lootTable: "elite",
    },
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "Cave Bear",
    description:
      "Territorial bear with heavy claw attacks. Two attack variants.",
  ...
  },
  {
    ...
    description:
      "Massive regenerating troll. Must be killed with fire to stop regen.",
  ...
  },
  {
    ...
    name: "Abyssal Kraken",
    description:
      "Tentacled boss with multiple attack patterns. Spawns near water.",
  ...
  },
  {
    ...
    name: "Ancient Ent",
    description:
      "Living tree. Extremely slow but massive HP and AoE root attacks.",
  ...
  // ════════════════════════════════════════════════════════════════════════
  // ENEMIES — NEW HIGH-FIDELITY ASSETS (mirrors creatures.ts + deployables.ts)
  // Keep these ids in lockstep with artifacts/arpg-game/src/data/creatures.ts;
  // bestiary.ts auto-synthesises stubs from the matching CreatureDef key.
  // ════════════════════════════════════════════════════════════════════════
  {
    id: "lizard_mule",
    kind: "monster",
    name: "Lizard Mule",
    description:
      "Tanky pack-beast. 7-clip GLB rig — full idle/walk/run/hit/death + 2 attacks.",
    modelPath: "/models/enemies/lizard_mule/lizard_mule.glb",
    scale: 0.014,
    data: {
      health: 240,
      damage: 22,
  ...
  {
    id: "skeleton_swordman",
    kind: "monster",
    name: "Skeleton Swordsman",
    description:
      "Re-knitted bonework with a bonded blade. Single-clip CINEMA_4D rig until split into idle/attack/die.",
    modelPath: "/models/enemies/skeleton_swordman/skeleton_swordman.glb",
    scale: 0.014,
    data: {
      health: 90,
      damage: 16,
      ...
      tier: "basic",
      role: "melee",
      behavior: "melee_advance",
      attackRange: 2,
      aggroRange: 10,
      animations: { idle: "CINEMA_4D" },
      lootTable: "basic",
    },
    tags: [
      "enemy",
  ...
  },
  {
    ...
    description:
      "Heavier overhead-chop variant. Single-clip CINEMA_4D rig until split into idle/attack/die.",
    modelPath: "/models/enemies/skeleton_axe/skeleton_axe.glb",
    scale: 0.014,
    data: {
      health: 130,
      damage: 24,
  ...
  },
  {
    ...
    name: "Tide Caller",
    description:
      "Stationary shrine boss. Static rig + procedural float bob; pulses a tidal AoE through standing water.",
    modelPath: "/models/enemies/tide_caller/tide_caller.glb",
    scale: 0.018,
    data: {
      health: 520,
      damage: 38,
      ...
      tier: "boss",
      role: "shrine_boss",
      behavior: "sentinel_static",
      attackRange: 12,
      aggroRange: 24,
      tidalPulseRadius: 12,
      tidalPulseInterval: 6,
      tidalPulseDamage: 38,
      summonAtHpThresholds: [0.75, 0.25],
      summonId: "seaexplorer",
      summonCount: 2,
      animations: { idle: "static", special: ["tidal_pulse"] },
      lootTable: "boss",
      dropGuarantee: true,
      spawnNear: "water",
    },
    tags: ["enemy", "boss", "shrine", "water", "static", "aoe"],
  },
  {
    id: "robot_t1",
    kind: "monster",
    name: "Robot T-1",
    description:
      "High-fidelity 55 MB GLB boss frame. Dual-role: also surfaces as a SYN-6 pilotable mech in deployables.",
    ...
    tags: ["enemy", "mech", "robot", "boss", "heavy", "dual-role"],
  },

  // ── Quaternius mech pack (Stan/Mike/Leela/George) — animated GLTF ────────
  // Hostile spawns. Player-deployable counterparts live in deployables.ts
  // with prefabIds mech_stan_ally / mech_mike_ally / mech_leela_ally /
  // mech_george_ally and the same model paths.
  {
    id: "mech_stan",
    kind: "monster",
    name: "STAN Walker",
    description:
      "Heavy bipedal mech. Slow, armored, and devastating in close range.",
    ...
    tags: ["enemy", "mech", "quaternius", "elite", "heavy"],
  },
  {
    id: "mech_mike",
    kind: "monster",
    name: "MIKE Walker",
    description: "Mid-weight assault mech. Balanced damage and armor.",
    ...
    tags: ["enemy", "mech", "quaternius", "elite", "assault"],
  },
  {
    id: "mech_leela",
    kind: "monster",
    name: "LEELA Walker",
    description: "Ranged mech. Extended kinetic-rifle reach; weaker armor.",
    ...
    tags: ["enemy", "mech", "quaternius", "elite", "ranged"],
  },
  {
    id: "mech_george",
    kind: "monster",
    name: "GEORGE Walker",
    description:
      "Skirmisher mech. Highest mobility in the pack; flanks and re-engages.",
    ...
    tags: ["enemy", "mech", "quaternius", "elite", "skirmisher", "fast"],
  },
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    ...
    data: {
      ...
      mountSpeed: 12,
      health: 500,
      tameRequirement: "dragon_taming_5",
    },
  ...
  },
  {
    ...
    scale: 1.0,
    data: {
      companionAI: "follow_attack",
      health: 150,
      damage: 12,
      speed: 6,
      tameRequirement: "beast_taming_1",
    },
  ...
  ...towerVariants("archer", "Archer Tower", "archers_tower", [
    {
      ...
      targeting: "nearest",
      projectile: "arrow",
      desc: "Basic arrow tower.",
    },
    {
      file: "_archers_tower_LVL_2.fbx",
      damage: 14,
      range: 25,
      attackSpeed: 1.8,
      health: 350,
      buildCost: { wood: 100, stone: 50, iron: 10 },
      targeting: "nearest",
      projectile: "arrow",
      desc: "Improved range and fire rate.",
    },
    {
      file: "_archers_tower_LVL_3.fbx",
      damage: 22,
      range: 30,
      attackSpeed: 2.0,
      health: 500,
      buildCost: { wood: 150, stone: 100, iron: 30 },
      targeting: "lowest_hp",
      projectile: "fire_arrow",
      desc: "Fire arrows, targets weakest.",
    },
    {
      file: "_arches_tower_LVL_4.fbx",
      damage: 30,
      range: 35,
      attackSpeed: 2.5,
      health: 750,
      buildCost: { wood: 200, stone: 150, iron: 60, gold: 20 },
      targeting: "lowest_hp",
      projectile: "explosive_arrow",
      desc: "Explosive arrows with AoE.",
    },
  ]),
  ...towerVariants("ballista", "Ballista Tower", "Ballista_tower", [
    {
      file: "_Ballista_tower_LVL_1.fbx",
      damage: 25,
      range: 30,
      attackSpeed: 0.5,
      health: 300,
      buildCost: { wood: 80, iron: 30 },
      targeting: "highest_hp",
      projectile: "bolt",
      desc: "High damage, slow fire.",
    },
    {
      file: "_Ballista_tower_LVL_2.fbx",
      damage: 40,
      range: 35,
      attackSpeed: 0.6,
      health: 500,
      buildCost: { wood: 120, iron: 60, steel: 10 },
      targeting: "highest_hp",
      projectile: "bolt",
      desc: "Piercing bolts.",
    },
    {
      file: "_Ballist_tower_LVL_3.fbx",
      damage: 60,
      range: 40,
      attackSpeed: 0.7,
      health: 700,
      buildCost: { wood: 160, iron: 90, steel: 30 },
      targeting: "highest_hp",
      projectile: "explosive_bolt",
      desc: "AoE explosive bolts.",
    },
    {
      file: "_Ballista_tower_LVL_4.fbx",
      damage: 80,
      range: 45,
      attackSpeed: 0.8,
      health: 1000,
      buildCost: { wood: 200, iron: 120, steel: 60, gold: 30 },
      targeting: "boss",
      projectile: "siege_bolt",
      desc: "Anti-boss siege weapon.",
    },
  ]),
  ...towerVariants("cannon", "Cannon Tower", "Cannon_tower", [
    {
      file: "_Cannon_tower_LVL_1.fbx",
      damage: 35,
      range: 25,
      attackSpeed: 0.4,
      health: 400,
      buildCost: { stone: 80, iron: 40 },
      targeting: "cluster",
      projectile: "cannonball",
      desc: "AoE splash damage.",
    },
    {
      file: "_Cannon_tower_LVL_2.fbx",
      damage: 55,
      range: 30,
      attackSpeed: 0.5,
      health: 600,
      buildCost: { stone: 120, iron: 80, gunpowder: 20 },
      targeting: "cluster",
      projectile: "cannonball",
      desc: "Larger blast radius.",
    },
    {
      file: "_Cannon_tower_LVL_3.fbx",
      damage: 75,
      range: 35,
      attackSpeed: 0.6,
      health: 850,
      buildCost: { stone: 160, iron: 120, gunpowder: 50 },
      targeting: "cluster",
      projectile: "explosive_shell",
      desc: "Fire damage added.",
    },
    {
      file: "_Cannon_tower_LVL_4.fbx",
      damage: 100,
      range: 40,
      attackSpeed: 0.7,
      health: 1200,
      buildCost: { stone: 200, iron: 160, gunpowder: 80, gold: 40 },
      targeting: "cluster",
      projectile: "napalm_shell",
      desc: "Napalm — burning ground effect.",
    },
  ]),
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "Nexus Mech",
    description:
      "Constructable combat mech. Requires SYN 8+ to pilot. Build at Mech Bay.",
